...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{ $data -> membername }}" placeholder="" id="membername" name="membername">
			</div>
		</div>
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9 skin-minimal">
			<div class="radio-box">
				<input name="gender" type="radio" value="男" id="sex-1" @if($data -> gender == '男') checked @endif>
				<label for="sex-1" value="男">男</label>
			</div>
			<div class="radio-box">
				<input type="radio" id="sex-2"  value="女" name="gender" @if($data -> gender == '女') checked @endif>
				<label for="sex-2" value="女">女</label>
			</div>
			<div class="radio-box">
				<input type="radio" id="sex-3" value="保密" name="gender" @if($data -> gender == '保密') checked @endif>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<div id="uploader-demo">
					...
					<!-- 隐藏域存放头像地址 -->
					<input type="hidden" name="avatarUrl" id="avatarUrl" value="{{ $data -> avatarUrl }}">
				</div>
			</div>
		</div>
		{{csrf_field()}}
